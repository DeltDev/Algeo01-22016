...
public class EnhancedIO { //Class ini untuk input lewat keyboard dan output secara umum
	...
	private static String findFileDir()
	{
		...
		String fileInput;
		Scanner in = new Scanner(System.in);
		System.out.print("Masukkan nama file (wajib diakhiri dengan .txt): ");
		fileInput = in.next();
	...
	public static void OutputDetFile(double d) {
		int inputSave;
		Scanner in = new Scanner(System.in);
		System.out.println("Apakah Anda ingin menyimpan data ini ke file?");
		System.out.println("1. Ya");
		...
		if(inputSave == 1) {
			...
			try {
			      FileWriter tulis = new FileWriter(filedir);
			      tulis.write("Determinan dari matriks tersebut adalah: ");
			      tulis.write(BigDecimal.valueOf(d).setScale(4,RoundingMode.HALF_EVEN).toPlainString());
			      tulis.write("\n");
			      tulis.close();
			      System.out.print("File tersimpan di ");
			      System.out.println(filedir);
	...
	public static void OutputInverseMatrixFile(Matrix m) {
		int inputSave;
		Scanner in = new Scanner(System.in);
		System.out.println("Apakah Anda ingin menyimpan data ini ke file?");
		System.out.println("1. Ya");
		...
		if(inputSave == 1) {
			...
			try {
			      FileWriter tulis = new FileWriter(filedir);
			      tulis.write("Invers matriks tersebut adalah:\n");
	...
	public static void OutputNoInverseFile() {
		int inputSave;
		Scanner in = new Scanner(System.in);
		System.out.println("Apakah Anda ingin menyimpan data ini ke file?");
		System.out.println("1. Ya");
		...
		if(inputSave == 1) {
			...
			try {
			      FileWriter tulis = new FileWriter(filedir);
			      tulis.write("Matriks tersebut tidak memiliki invers.");
			      tulis.close();
			      System.out.print("File tersimpan di ");
			      System.out.println(filedir);
			} catch (IOException e) {
	...
	public static void OutputBSIFile(double x, double y, double taksir) {
		int inputSave;
		Scanner in = new Scanner(System.in);
		System.out.println("Apakah Anda ingin menyimpan data ini ke file?");
		System.out.println("1. Ya");
		...
		if(inputSave == 1) {
			...
			try {
			      FileWriter tulis = new FileWriter(filedir);
			      tulis.write("Taksiran nilai f(x,y) yang diinput adalah:\n");
			      tulis.write("f(");
			      tulis.write(BigDecimal.valueOf(x).setScale(4,RoundingMode.HALF_EVEN).toPlainString());
			      tulis.write(", ");
			      tulis.write(BigDecimal.valueOf(y).setScale(4,RoundingMode.HALF_EVEN).toPlainString());
			      tulis.write(") = ");
			      tulis.write(BigDecimal.valueOf(taksir).setScale(4,RoundingMode.HALF_EVEN).toPlainString());
			      tulis.write("\n");
			      tulis.close();
			      System.out.print("File tersimpan di ");
			      System.out.println(filedir);
	...
	public static void OutputPIFile(SPLTuples SPL, double x,double taksiran) {
		int inputSave;
		Scanner in = new Scanner(System.in);
		System.out.println("Apakah Anda ingin menyimpan data ini ke file?");
		System.out.println("1. Ya");
		...
		if(inputSave == 1) {
			...
			try {
			      FileWriter tulis = new FileWriter(filedir);
			      tulis.write("Polinomial interpolasi yang didapat adalah:\n");
			      tulis.write("f(x) = ");
					...
					for(i = 0; i<SPL.Solution.length; i++) {
						...
						if(SPL.Solution[i] >= 0.0001) { //cek koefisien yang dianggap sangat kecil sehingga dapat diabaikan
							...
							if(i != 0) {
								...
								if(i != 1) {
									tulis.write("^");
									tulis.write(Integer.toString(i));
								}
							}
			      ...
			      tulis.write("\n");
			      tulis.write("Taksiran nilai f(x) yang diinput adalah:\n");
			      tulis.write("f(");
			      tulis.write(BigDecimal.valueOf(x).setScale(4,RoundingMode.HALF_EVEN).toPlainString());
			      tulis.write(") = ");
			      tulis.write(BigDecimal.valueOf(taksiran).setScale(4,RoundingMode.HALF_EVEN).toPlainString());
			      tulis.write("\n");
			      tulis.close();
			      System.out.print("File tersimpan di ");
			      System.out.println(filedir);
	...
	public static void OutputMulRegFile(SPLTuples SPL, MulRegTuple Regresi,double taksiran) {
		int inputSave;
		Scanner in = new Scanner(System.in);
		System.out.println("Apakah Anda ingin menyimpan data ini ke file?");
		System.out.println("1. Ya");
		...
		if(inputSave == 1) {
			...
			try {
			      FileWriter tulis = new FileWriter(filedir);
			      tulis.write("Persamaan regresi linear yang didapat adalah:\n");
			      tulis.write("y = ");
			      ...
			      tulis.write("\n");
			      tulis.write("Nilai taksiran f(xk) yang didapat adalah:\n");
			      tulis.write("f(");
			      for(i = 0; i<Regresi.variables; i++) {
						if(i == Regresi.variables-1) {
							tulis.write(BigDecimal.valueOf(Regresi.xtest[i]).setScale(4,RoundingMode.HALF_EVEN).toPlainString());
							tulis.write(") = ");
						} else {
							tulis.write(BigDecimal.valueOf(Regresi.xtest[i]).setScale(4,RoundingMode.HALF_EVEN).toPlainString());
							tulis.write(", ");
